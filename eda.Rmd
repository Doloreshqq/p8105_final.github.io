...
# Plot: depression level vs. race groups
```{r}
dass_new|>
...
# Chi-squared Test 1
From the plot above, we observed that the distribution of depression level among different age groups follow a similar pattern. Thus, we would like to perform a chi-squared test to study if the distribution of depression levels among different age groups are the same.\
