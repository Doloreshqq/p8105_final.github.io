...
According to this graph, the ROC curves for "Moderate or Below" and "Extremely Severe" are close to the top-left corner of the plot, showing a good performance in these two categories. The performance on "Severe" may indicate that we need more data points that have a depression level of "Severe."

# Depression Levels Distribution
The following graphs show the probability of depression level on different categorical and continuous variables.
