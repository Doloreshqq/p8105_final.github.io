...
fitted_values <- predict(dass_fit_step, type = "probs")
residuals <- resid(dass_fit_step, type = "pearson")
...
### QQ Plot
```{r}
qqnorm(residuals, main = "Normal Q-Q Plot", col = "blue")
qqline(residuals, col = "red")
```

### Scale-Location Plot
```{r}
std_residuals <- residuals / sqrt(1 - residuals^2)
plot(fitted_values, abs(std_residuals),
     xlab = "Fitted values",
...
```{r}
library(car)
residualPlots(dass_fit_step, type = "pearson")
```

### Cook's Distance Plot
```{r}
plot(cooks.distance(dass_fit_step), pch = 20, main = "Cook's Distance Plot", xlab = "Index", ylab = "Cook's Distance")
